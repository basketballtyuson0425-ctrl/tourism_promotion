...
- 比較対象は広島県（宮島）
- 分析対象SNSはYouTube
- 対象ターゲットは中国・台湾・韓国・米国・香港の5市場
- 分析対象言語は中国語（簡体字・繁体字）、韓国語、英語、広東語表現
- 今回は本格的なYouTube API連携ではなく、サンプルデータと最小バックエンドを用いたデモとして作成
...
今回のデモでは、YouTube APIへの本格接続そのものよりも、どのデータを見て、どのように観光プロモーション施策につなげるかを示すことを優先しました。
